...
of the Riemann curvature tensor, and the \textbf{Ricci scalar} is $R = g^{\mu\nu}R_{\mu\nu}$. \\
...
%\bigskip\noindent
\subsection*{Mostly-Plus vs. Mostly-Minus Signatures}
The choice of metric signature affects the signs of above tensors in below ways:
\begin{center}
      \begin{tabular}{@{}lll@{}}
      \toprule
      \textbf{Tensor} & \textbf{Symbol} & \textbf{Sign Change} \\
      \midrule
      Metric& $g_{\mu\nu}$ & Flips $(-)$ \\
      Inverse metric & $g^{\mu\nu}$ & Flips $(-)$ \\
...
\clearpage
\section{Spherical Harmonics \& Associated Legendre Polynomials}

We adopt the Condon--Shortley phase convention:
\begin{align*}
      Y_l^m(\theta,\phi) &= N_{lm}\,P_l^m(\cos\theta)\,e^{im\phi},\\
      N_{lm} &= \sqrt{\frac{2l+1}{4\pi}\frac{(l-m)!}{(l+m)!}},\\
      Y_l^{-m}(\theta,\phi) &= (-1)^m N_{lm}\,P_l^m(\cos\theta)\,e^{-im\phi},\qquad (m>0).
\end{align*}

The real spherical harmonics are constructed as
\begin{align*}
      Y_{l,m}^{(c)}(\theta,\phi) &= \frac{1}{\sqrt2}\Bigl(Y_l^{-m}+(-1)^mY_l^m\Bigr)
      = \sqrt2\,N_{lm}\,P_l^m(\cos\theta)\cos(m\phi),\qquad m>0,\\
      Y_{l,m}^{(s)}(\theta,\phi) &= \frac{1}{i\sqrt2}\Bigl(Y_l^{-m}-(-1)^mY_l^m\Bigr)
      = \sqrt2\,N_{lm}\,P_l^m(\cos\theta)\sin(m\phi),\qquad m<0,\\
      Y_{l,0}(\theta,\phi) &= N_{l0}\,P_l(\cos\theta).
\end{align*}

\subsection*{Associated Legendre Polynomials $P_l^m(x)$ for $0\le l\le4$}
Let $x\equiv\cos\theta$.
\begin{align*}
      l=0:&\quad P_0^0(x)=1.\\
      l=1:&\quad P_1^0(x)=x,\qquad P_1^1(x)=-(1-x^2)^{1/2}.\\
      l=2:&\quad P_2^0(x)=\tfrac12(3x^2-1),\qquad P_2^1(x)=-3x(1-x^2)^{1/2},\qquad P_2^2(x)=3(1-x^2).\\
      l=3:&\quad P_3^0(x)=\tfrac12(5x^3-3x),\qquad P_3^1(x)=-\tfrac32(5x^2-1)(1-x^2)^{1/2},\\
                  &\quad P_3^2(x)=15x(1-x^2),\qquad P_3^3(x)=-15(1-x^2)^{3/2}.\\
      l=4:&\quad P_4^0(x)=\tfrac18(35x^4-30x^2+3),\qquad P_4^1(x)=-\tfrac52(7x^3-3x)(1-x^2)^{1/2},\\
                  &\quad P_4^2(x)=\tfrac{15}{2}(7x^2-1)(1-x^2),\qquad P_4^3(x)=-105x(1-x^2)^{3/2},\\
                  &\quad P_4^4(x)=105(1-x^2)^2.
\end{align*}

\clearpage
\subsection*{Real Spherical Harmonics Table for $0\le l\le4$}
\begin{align*}
      l=0:\quad &Y_{0,0}=\sqrt{\frac{1}{4\pi}}.\\
      l=1:\quad &Y_{1,0}=\sqrt{\frac{3}{4\pi}}\,P_1^0(\cos\theta),\\
                                    &Y_{1,1}^{(c)}=\sqrt{\frac{3}{4\pi}}\,P_1^1(\cos\theta)\cos\phi,\qquad
                                     Y_{1,1}^{(s)}=\sqrt{\frac{3}{4\pi}}\,P_1^1(\cos\theta)\sin\phi.\\
      l=2:\quad &Y_{2,0}=\sqrt{\frac{5}{4\pi}}\,P_2^0(\cos\theta),\\
                                    &Y_{2,1}^{(c)}=\sqrt{\frac{5}{12\pi}}\,P_2^1(\cos\theta)\cos\phi,\qquad
                                     Y_{2,1}^{(s)}=\sqrt{\frac{5}{12\pi}}\,P_2^1(\cos\theta)\sin\phi,\\
                                    &Y_{2,2}^{(c)}=\sqrt{\frac{5}{48\pi}}\,P_2^2(\cos\theta)\cos(2\phi),\qquad
                                     Y_{2,2}^{(s)}=\sqrt{\frac{5}{48\pi}}\,P_2^2(\cos\theta)\sin(2\phi).\\
      l=3:\quad &Y_{3,0}=\sqrt{\frac{7}{4\pi}}\,P_3^0(\cos\theta),\\
                                    &Y_{3,1}^{(c)}=\sqrt{\frac{7}{24\pi}}\,P_3^1(\cos\theta)\cos\phi,\qquad
                                     Y_{3,1}^{(s)}=\sqrt{\frac{7}{24\pi}}\,P_3^1(\cos\theta)\sin\phi,\\
                                    &Y_{3,2}^{(c)}=\sqrt{\frac{7}{240\pi}}\,P_3^2(\cos\theta)\cos(2\phi),\qquad
                                     Y_{3,2}^{(s)}=\sqrt{\frac{7}{240\pi}}\,P_3^2(\cos\theta)\sin(2\phi),\\
                                    &Y_{3,3}^{(c)}=\sqrt{\frac{7}{2880\pi}}\,P_3^3(\cos\theta)\cos(3\phi),\qquad
                                     Y_{3,3}^{(s)}=\sqrt{\frac{7}{2880\pi}}\,P_3^3(\cos\theta)\sin(3\phi).\\
      l=4:\quad &Y_{4,0}=\sqrt{\frac{9}{4\pi}}\,P_4^0(\cos\theta),\\
                                    &Y_{4,1}^{(c)}=\sqrt{\frac{9}{40\pi}}\,P_4^1(\cos\theta)\cos\phi,\qquad
                                     Y_{4,1}^{(s)}=\sqrt{\frac{9}{40\pi}}\,P_4^1(\cos\theta)\sin\phi,\\
                                    &Y_{4,2}^{(c)}=\sqrt{\frac{1}{80\pi}}\,P_4^2(\cos\theta)\cos(2\phi),\qquad
                                     Y_{4,2}^{(s)}=\sqrt{\frac{1}{80\pi}}\,P_4^2(\cos\theta)\sin(2\phi),\\
                                    &Y_{4,3}^{(c)}=\sqrt{\frac{1}{1120\pi}}\,P_4^3(\cos\theta)\cos(3\phi),\qquad
                                     Y_{4,3}^{(s)}=\sqrt{\frac{1}{1120\pi}}\,P_4^3(\cos\theta)\sin(3\phi),\\
                                    &Y_{4,4}^{(c)}=\sqrt{\frac{1}{8960\pi}}\,P_4^4(\cos\theta)\cos(4\phi),\qquad
                                     Y_{4,4}^{(s)}=\sqrt{\frac{1}{8960\pi}}\,P_4^4(\cos\theta)\sin(4\phi).
\end{align*}

\bigskip
\noindent
The above keeps the exact $\sqrt{\cdot}$ normalization and explicit angular dependence
$(\theta,\phi)$, while using a real-valued basis.
\clearpage
...
C$\nu$B temperature ($T_{\text{C}\nu\text{B}}$) & $1.95 \,\mathrm{K}$ \\
\bottomrule
\end{tabular}
\end{center}
...
\clearpage
\section{Main Events in Universe}
\begin{center}
\begin{tabular}{llll}
\toprule
\textbf{Event} & \textbf{Time $t$} & \textbf{Redshift $z$} & \textbf{Temperature $T$ (eV)} \\
\midrule
Planck epoch & $10^{-43}\,\mathrm{s}$ & -- & -- \\
Grand unification & $10^{-36}\,\mathrm{s}$ & -- & -- \\
Inflation & $10^{-34}\,\mathrm{s}$ (?) & -- & -- \\
Baryogenesis & ? & ? & ? \\
EW phase transition & $2\times10^{-11}\,\mathrm{s}$ & $10^{15}$ & $10^{11}$ \\
QCD phase transition & $2\times10^{-5}\,\mathrm{s}$ & $10^{12}$ & $1.5\times10^{8}$ \\
Dark matter freeze-out & ? & ? & ? \\
Neutrino decoupling & $1\,\mathrm{s}$ & $6\times10^{9}$ & $10^{6}$ \\
Electron-positron annihilation & $6\,\mathrm{s}$ & $2\times10^{9}$ & $5\times10^{5}$ \\
Big Bang nucleosynthesis & $3\,\mathrm{min}$ & $4\times10^{8}$ & $10^{5}$ \\
Matter-radiation equality & $6\times10^{4}\,\mathrm{yr}$ & $3400$ & $0.75$ \\
Recombination & $(2.6\text{--}3.8)\times10^{5}\,\mathrm{yr}$ & $1100\text{--}1400$ & $0.26\text{--}0.33$ \\
Photon decoupling & $3.8\times10^{5}\,\mathrm{yr}$ & $1000\text{--}1200$ & $0.23\text{--}0.28$ \\
Reionization & $(1\text{--}4)\times10^{8}\,\mathrm{yr}$ & $11\text{--}30$ & $(2.6\text{--}7.0)\times10^{-3}$ \\
Dark energy-matter equality & $9\times10^{9}\,\mathrm{yr}$ & $0.4$ & $3.3\times10^{-4}$ \\
Present & $1.38\times10^{10}\,\mathrm{yr}$ & $0$ & $2.4\times10^{-4}$ \\
\bottomrule
\end{tabular}
\end{center}
