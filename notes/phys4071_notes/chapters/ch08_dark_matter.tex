...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.55\textwidth]{images/positron_fraction_energy_spectrum.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.55\textwidth]{images/cosmic_rays_spectrum_mass.png}
