...
\begin{foundation}
    ...
    \begin{align*}
        n_i &= g_i \left( \frac{m_i T}{2 \pi}^{3/2} \right)e^{\frac{Z_i \mu_p + (A_i - Z_i) \mu_n - m_i}{T}}  \\
            ...
            &= g_i \left( (\frac{2\pi}{T})^{A_i - 1} \frac{m_N A_i}{m_N^{Z_i} m_N^{A_i - Z_i}} \right)^{3/2} \left(n_p^{Z_i} n_n^{A_i - Z_i}\right) \left( 2^{-A_i} \right) \left( e^{B_i / T} \right) \\
            &= g_i \left( (\frac{2\pi}{T})^{A_i - 1} \frac{A_i}{m_N^{A_i - 1}} \right)^{3/2} \left(n_p^{Z_i} n_n^{A_i - Z_i}\right) 2^{-A_i} e^{B_i / T} \\
...
\begin{foundation}
    ...
    \begin{align*}
        X_i &= g_i \cdot \left(A_i^{5/2} 2^{-A_i}\right) \cdot  \left(X_p^{Z_i} X_n^{A_i - Z_i}\right) \cdot \left( 2^{A_i - 1} (\frac{n_B}{2})^{A_i - 1} (\frac{2\pi}{m_N T})^{\frac{3}{2}(A_i - 1)} e^{B_i / T} \right) \\
