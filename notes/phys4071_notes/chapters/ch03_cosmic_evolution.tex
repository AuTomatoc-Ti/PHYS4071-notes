...
\begin{foundation}
    ...
    By brunches of tedious calculations from Christoffel symbols, Riemann curvature tensor(If you really want to do the calculation, you can used the equations in the appendix B.2, trust me, it will not be a good idea), we can find out the Ricci tensor and Ricci scalar as below:
    \[
        \begin{cases}
...
\begin{theory}
    ...
    And we can see that the energy is constant throughout spacetime with negative pressure, and we said that the cosmological constant is equivalent to vacuum energy. \\
\end{theory}
...
\bigskip \noindent
\begin{theory}
    By considering the cosmological constant, the 1st Friedmann equations becomes:
    \[
...
% ──────────────────────────────────────────────────────────────────────────────
\bigskip \noindent \bigskip \noindent \bigskip \noindent
\subsection{Evolution of Scale Factor}
