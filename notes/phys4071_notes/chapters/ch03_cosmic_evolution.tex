...
\begin{theory}
    ...
    \end{align*}
    where $\frac{\rho}{\rho_c} = \Omega_{mr} = \Omega_{m} + \Omega_{r}$ is the contribution of matter and radiation, $\Omega_\Lambda = \frac{\rho_\Lambda}{\rho_c}$ is the contribution of cosmological constant, and $\Omega_K = \frac{\rho_K}{\rho_c} = -\frac{3k}{8\pi G a^2 \rho_c}$ is the contribution of curvature. \\
