...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/g_star_evolution.png}
...
\clearpage
%\bigskip\noindent \bigskip\noindent \bigskip\noindent
\subsection{\texorpdfstring{$g_*$ and $g_{*s}$}{g* and g*s} in the early universe}
\begin{foundation}
...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption[Thermal history timeline.]{Thermal history timeline of major decoupling events.}
