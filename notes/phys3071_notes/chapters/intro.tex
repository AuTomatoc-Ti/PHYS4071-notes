...
These notes accompany the PHYS3071 Introduction to Stellar Astrophysics course in Hong Kong University of Science and Technology (HKUST).
...
\medskip\noindent
The material focuses on core stellar-astrophysics topics, including stellar structure,
energy generation in stars, radiative transport, and observational diagnostics such as
...
\medskip\noindent
If you find any errors or have suggestions for improvement, please feel free to contact me at \texttt{\NoteAuthorEmail}.
...
When relativistic expressions are needed, we adopt the \emph{mostly-plus} (or ``$(-, +, +, +)$'') signature:
\[
...
In sections involving high-energy or compact-object estimates,
...
\begin{tabular}{@{}lll@{}}
  ...
  $R_\odot$                & Solar radius                      & $\mathrm{m}$ \\
  $L_\odot$                & Solar luminosity                  & $\mathrm{W}$ \\
  $T_\mathrm{eff}$         & Effective temperature             & $\mathrm{K}$ \\
...
\begin{remark}
  Unless otherwise stated, stellar quantities are quoted in solar-normalised form
  (for example $M/M_\odot$ and $L/L_\odot$), which makes scaling relations easier
  to compare across different stellar masses.
\end{remark}
